...
public class RangeTest extends TestCase {
	...
	public void testContainsTwoSameNegativeInputFalse() {
		...
		assertEquals("Input values: -42 and -42. Testing if contains -19. Should return false.", false,
				r.contains(-19));
	}
	...
	public void testGetLengthTwoPositiveInputs() {
		...
		assertEquals("Input values: 4 and 9. Should return 5", 5.0, r.getLength());
	}

	@Test
	public void testGetLengthTwoNegativeInputs() {
		Range r = new Range(-17, -1);
		assertEquals("Input values: -17 and -1. Should return 16", 16.0, r.getLength());
	}

	@Test
	public void testGetLengthOnePositiveOneNegativeInput() {
		Range r = new Range(-53, 64);
		assertEquals("Input values: -53 and 64. Should return 117", 117.0, r.getLength());
	}

	@Test
	public void testGetLengthWithSameNumber() {
		Range r = new Range(8, 8);
		assertEquals("Input values: 8 and 8. Should return 0", 0.0, r.getLength());
	}
	...
	public void oooooooooooooheyintersect() {
		...
		assertEquals("is it  true?", true, r.intersects(0.5, 1.5));
	}
	...
	public void eeeeeeeeeeeeeeeeeequals() {
		...
		assertEquals("yes true?", true, r1.equals(r2));
		assertEquals("yes true?", true, r2.equals(r1));
		assertEquals("nooo!!!!", false, r1.equals(r3));
	}
